---
slug: custom-made-sun-lounge-cover
headline: Custom Made Sun Lounge Cover
headlinePrefix: Custom Made
headlineEmphasis: Sun Lounge
headlineSuffix: Cover
subLabel: Custom Made · Sun Lounge Cover
breadcrumbCurrent: Sun Lounge Cover
...
faqs:
  - q: My sun lounge has an adjustable backrest. Which position do I measure height in?
    a: Measure with the backrest in the position you normally leave it when the lounger is stored or not in use. If you store it flat, measure the height from the ground to the top of the frame in the flat position. The cover is made to fit the lounger as it sits, not every possible recline angle.
  - q: Should I put the cover on with the cushions on or off?
    a: Either works, but covering the cushions in place gives you better protection and saves you from finding somewhere dry to store them separately. The cover is made to fit the whole lounger including a standard cushion depth. If your cushions are unusually thick, mention this in the order notes so we can account for it.
...
cta:
  ...
  body: Our team is happy to help. Send us a photo of your sun lounge and rough dimensions and we will sort out the measurements for you.
---
