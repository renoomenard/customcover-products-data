---
slug: custom-made-rectangle-table-cover
headline: Custom Made Rectangle Table Cover
headlinePrefix: Custom Made
headlineEmphasis: Rectangle Table
headlineSuffix: Cover
subLabel: Custom Made · Rectangle Table Cover
breadcrumbCurrent: Rectangle Table Cover
...
faqs:
  - q: Which dimension is width and which is depth?
    a: Width is the longest side of the table and depth is the shorter side. If you are standing at one end looking along the length of the table, width is the measurement running away from you and depth is the measurement running side to side. If your table is square, either measurement can be width and the other depth — just be consistent.
  - q: Should I include the chairs in the measurements?
    a: No. The cover is for the table only. Measure just the tabletop dimensions. Chairs are not included in the cover dimensions, regardless of whether they will be pushed close to the table or away from it when the cover goes on.
  - q: Can I put the cover on with the chairs tucked under the table?
  ...
  - q: My table has an umbrella hole in the centre. Can I get a cover with a hole in it?
    a: The standard cover is made to go over the table with the umbrella removed. If you want to leave the umbrella in place while the cover is on, add a note in the order comments and our team will advise on the best approach before production starts.
  - q: Does the cover work for a table with bench seats instead of chairs?
    a: Yes. Bench seats sit outside the table footprint, so they do not affect the table measurements. The cover is made to the tabletop dimensions only. Whether you have chairs, bench seats, or no seating at all, the measurements are the same.
