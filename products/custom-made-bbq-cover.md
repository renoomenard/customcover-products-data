---
slug: custom-made-bbq-cover
headline: Custom Made BBQ Cover
headlinePrefix: Custom Made
headlineEmphasis: BBQ
headlineSuffix: Cover
subLabel: Custom Made · Rectangular BBQ Cover
breadcrumbCurrent: BBQ Cover
...
faqs:
  - q: Do I include the side shelves in my width measurement?
    a: Yes — if the side shelves are a permanent part of the unit (bolted on or fixed), include them in your width measurement. If they fold down and you store the BBQ with them folded, measure with them folded down. The cover should fit however you normally leave the BBQ.
  - q: My BBQ lid is curved. How do I measure height?
    a: Measure from the ground (or base of the trolley) to the very top of the lid in its fully closed position. The cover sits over the lid rather than inside the curve, so the outside height is what matters.
  - q: Should I measure with the BBQ on its trolley or just the body?
    a: Measure the whole unit as it sits in your outdoor space — trolley and all. The cover goes over everything, so height should run from floor to lid top.
  - q: Can I order a cover with a vent or opening for the exhaust?
    a: Yes — add a note in the order comments when you submit your quote. Our team will confirm the placement and size before production starts.
  - q: What if my BBQ is not a perfect rectangle?
    a: Most BBQs are close enough to rectangular that this cover works well. If yours has a significantly unusual shape, contact us before ordering and we can advise on the best approach.
